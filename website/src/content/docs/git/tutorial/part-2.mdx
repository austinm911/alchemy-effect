...
description: Create a repository on your host, push to it, then let anyone read a public one. The REST plane and the shared secret, used before anything else depends on them.
---
